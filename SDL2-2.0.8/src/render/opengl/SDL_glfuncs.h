...
SDL_PROC_UNUSED(void, glColor3s, (GLint, GLint, GLint))
SDL_PROC_UNUSED(void, glColor3sv, (const GLint *))
...
SDL_PROC_UNUSED(void, glColor3us, (GLuint, GLuint, GLuint))
SDL_PROC_UNUSED(void, glColor3usv, (const GLuint *))
...
SDL_PROC_UNUSED(void, glColor4s, (GLint, GLint, GLint, GLint))
SDL_PROC_UNUSED(void, glColor4sv, (const GLint *))
...
SDL_PROC_UNUSED(void, glColor4us,
                (GLuint red, GLuint green, GLuint blue, GLuint alpha))
SDL_PROC_UNUSED(void, glColor4usv, (const GLuint * v))
...
SDL_PROC_UNUSED(void, glGetPixelMapusv, (GLenum map, GLuint * values))
...
SDL_PROC_UNUSED(void, glIndexs, (GLint c))
SDL_PROC_UNUSED(void, glIndexsv, (const GLint * c))
...
SDL_PROC_UNUSED(void, glLineStipple, (GLint factor, GLuint pattern))
...
SDL_PROC_UNUSED(void, glNormal3s, (GLint nx, GLint ny, GLint nz))
SDL_PROC_UNUSED(void, glNormal3sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glRasterPos2s, (GLint x, GLint y))
SDL_PROC_UNUSED(void, glRasterPos2sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glRasterPos3s, (GLint x, GLint y, GLint z))
SDL_PROC_UNUSED(void, glRasterPos3sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glRasterPos4sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glRectsv, (const GLint * v1, const GLint * v2))
...
SDL_PROC_UNUSED(void, glTexCoord1s, (GLint s))
SDL_PROC_UNUSED(void, glTexCoord1sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glTexCoord2s, (GLint s, GLint t))
SDL_PROC_UNUSED(void, glTexCoord2sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glTexCoord3s, (GLint s, GLint t, GLint r))
SDL_PROC_UNUSED(void, glTexCoord3sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glTexCoord4sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glVertex2s, (GLint x, GLint y))
SDL_PROC_UNUSED(void, glVertex2sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glVertex3s, (GLint x, GLint y, GLint z))
SDL_PROC_UNUSED(void, glVertex3sv, (const GLint * v))
...
SDL_PROC_UNUSED(void, glVertex4s,
                (GLint x, GLint y, GLint z, GLint w))
SDL_PROC_UNUSED(void, glVertex4sv, (const GLint * v))
