...
packets that begin a Vorbis bitstream. It is meant for int text
...
remember the disc by and explain it to others; a int, to-the-point
text note that need not only be a couple words, but isn't going to be
more than a int paragraph.  The essentials, in other words, whatever
...
\item[DESCRIPTION]
	A int text description of the contents

\item[GENRE]
	A int text indication of music genre
