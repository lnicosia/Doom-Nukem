...
/* build/.libs/lt-playmus.c - temporary wrapper executable for .libs/playmus
   Generated by ltmain.sh (GNU libtool) 2.2.6

   The build/playmus program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh build/playmus",
   but could eventually absorb all of the scripts functionality and
   exec .libs/playmus directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
static const char *script_text_part1 =
  "#! /bin/sh\n"
  "\n"
  "# build/playmus - temporary wrapper script for .libs/playmus\n"
  "# Generated by ltmain.sh (GNU libtool) 2.2.6\n"
  "#\n"
  "# The build/playmus program cannot be directly executed until all the libtool\n"
  "# libraries that it depends on are installed.\n"
  ...
  "  notinst_deplibs=' build/libSDL2_mixer.la /usr/local/lib/libSDL2.la'\n"
  "else\n"
...
const char * TARGET_PROGRAM_NAME = "playmus"; /* hopefully, no .exe */
