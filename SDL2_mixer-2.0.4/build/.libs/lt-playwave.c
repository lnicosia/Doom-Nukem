...
/* build/.libs/lt-playwave.c - temporary wrapper executable for .libs/playwave
   Generated by ltmain.sh (GNU libtool) 2.2.6

   The build/playwave program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh build/playwave",
   but could eventually absorb all of the scripts functionality and
   exec .libs/playwave directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
static const char *script_text_part1 =
  "#! /bin/sh\n"
  "\n"
  "# build/playwave - temporary wrapper script for .libs/playwave\n"
  "# Generated by ltmain.sh (GNU libtool) 2.2.6\n"
  "#\n"
  "# The build/playwave program cannot be directly executed until all the libtool\n"
  "# libraries that it depends on are installed.\n"
