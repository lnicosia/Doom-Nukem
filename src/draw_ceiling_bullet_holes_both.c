...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   draw_ceiling_bullet_holes_both.c                   :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
void	draw_current_ceiling_bullet_hole_both(t_drawer *drawer, t_env *env)
{
...
void	draw_ceiling_bullet_hole_both(t_bullet_hole *curr, t_drawer *drawer,
t_env *env)
{
	Uint32		*sprite_pixels;
...
t_env *env)
{
	...
	while (bullet_holes)
	{
		...
		draw_ceiling_bullet_hole_both(curr, drawer, env);
