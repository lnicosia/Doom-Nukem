...
/*   Updated: 2020/03/11 11:40:07 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_object_general_buttons(t_env *env)
{
	...
	env->editor.hud.g_object.pos_y.pos = new_point(170, 520);
	env->editor.hud.g_object.t_pos_y.pos = new_point(170, 520);
	...
	env->editor.hud.g_object.health.pos = new_point(170, 560);
	env->editor.hud.g_object.t_health.pos = new_point(170, 560);
	env->editor.hud.g_object.scale = new_hud_button(ON_RELEASE,
	&change_object_scale, &env->editor.hud.g_object.t_scale, env);
	env->editor.hud.g_object.scale.pos = new_point(170, 600);
	env->editor.hud.g_object.t_scale.pos = new_point(170, 600);
	env->editor.hud.g_object.damage = new_hud_button(ON_RELEASE,
	&change_object_damage, &env->editor.hud.g_object.t_damage, env);
	env->editor.hud.g_object.damage.pos = new_point(170, 640);
	env->editor.hud.g_object.t_damage.pos = new_point(170, 640);
	env->editor.hud.g_object.angle = new_hud_button(ON_RELEASE,
	&change_angle, &env->editor.hud.g_object.t_angle, env);
	env->editor.hud.g_object.angle.pos = new_point(170, 680);
	env->editor.hud.g_object.t_angle.pos = new_point(170, 680);
}
