...
{
	env->editor.hud.s_object.brightness = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_object.color = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_object.intensity = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_object.gravity = new_hud_button(WHEN_DOWN, &change_var,
...
{
	env->editor.hud.g_object.pos_x = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_object.pos_y = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_object.pos_z = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_object.health = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_object.speed = new_hud_button(WHEN_DOWN, &change_var,
