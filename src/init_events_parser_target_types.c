...
/*   Updated: 2020/01/16 12:43:02 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	eparser->target_parsers[SECTOR_FLOOR_SPRITES_SPRITE] = &wall_sprite_parser;
	eparser->target_parsers[SECTOR_FLOOR_SPRITES_POS_X] = &wall_sprite_parser;
	eparser->target_parsers[SECTOR_FLOOR_SPRITES_POS_Y] = &wall_sprite_parser;
	eparser->target_parsers[SECTOR_FLOOR_SPRITES_SCALE_X] = &wall_sprite_parser;
	eparser->target_parsers[SECTOR_FLOOR_SPRITES_SCALE_Y] = &wall_sprite_parser;
	eparser->target_parsers[SECTOR_CEILING_SPRITES_SPRITE] =
	&wall_sprite_parser;
	eparser->target_parsers[SECTOR_CEILING_SPRITES_POS_X] = &wall_sprite_parser;
	eparser->target_parsers[SECTOR_CEILING_SPRITES_POS_Y] = &wall_sprite_parser;
