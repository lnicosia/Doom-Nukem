...
/*   Updated: 2019/05/14 13:39:50 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_camera(t_env *env)
{
	...
	env->camera.near_left = tan(env->camera.hfov / 2) * env->camera.near_z;
	env->camera.near_right = -tan(env->camera.hfov / 2) * env->camera.near_z;
