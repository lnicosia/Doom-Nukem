...
void	draw_current_floor_bullet_hole_no_light(t_drawer *drawer, t_env *env)
{
...
void	draw_floor_bullet_hole_no_light(t_bullet_hole *curr, t_drawer *drawer,
t_env *env)
{
	Uint32		*sprite_pixels;
...
t_env *env)
{
	...
	while (bullet_holes)
	{
		...
		draw_floor_bullet_hole_no_light(curr, drawer, env);
