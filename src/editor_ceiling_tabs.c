...
/*   Updated: 2020/02/04 14:19:50 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		print_ceiling_sprite_tab(t_env *env)
{
	...
	ft_snprintf(env->snprintf, 20, "%.5f", env->sectors[env->selected_ceiling].
...
int		print_ceiling_sector_tab(t_env *env)
{
	...
	env->sdl.fonts.alice30, 0xFFFFFFFF, 30), env);
	ft_snprintf(env->snprintf, 20, "%d", env->selected_ceiling);
