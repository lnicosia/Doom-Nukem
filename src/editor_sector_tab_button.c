...
/*   Updated: 2020/01/22 10:34:40 by sipatry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	env->editor.hud.g_sector.brightness = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_sector.color = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_sector.intensity = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_sector.ceiling = new_hud_button(WHEN_DOWN, &change_var,
	&env->editor.hud.g_sector.t_ceilling, env);
	env->editor.hud.g_sector.ceiling.pos = new_point(250, 640);
	env->editor.hud.g_sector.t_ceilling.pos = new_point(250, 640);
	env->editor.hud.g_sector.floor = new_hud_button(WHEN_DOWN, &change_var,
	&env->editor.hud.g_sector.t_floor, env);
	env->editor.hud.g_sector.floor.pos = new_point(250, 680);
	env->editor.hud.g_sector.t_floor.pos = new_point(250, 680);
	env->editor.hud.g_sector.floor_slope = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_sector.ceiling_slope = new_hud_button(WHEN_DOWN, &change_var,
