...
t_bullet_hole	init_ceiling_projectile_bullet_hole(t_sector *sector,
t_projectile *projectile, t_env *env)
{
	t_bullet_hole	bullet_hole;

	bullet_hole.pos = get_ceiling_bullet_hole_pos(sector, projectile, env);
...
t_projectile *projectile, t_env *env)
{
	...
	bullet_hole = init_ceiling_projectile_bullet_hole(sector, projectile, env);
