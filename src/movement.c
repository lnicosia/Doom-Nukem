...
/*   Updated: 2019/04/12 15:05:08 by aherriau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player(t_env *env)
{
	...
	{
		env->player.pos.x += env->player.dir.x * env->player.speed;
		env->player.pos.y += env->player.dir.y * env->player.speed;
	}
	...
	{
		env->player.pos.x += env->player.dir.y * env->player.speed;
		env->player.pos.y -= env->player.dir.x * env->player.speed;
	}
