...
/*   Updated: 2020/03/11 12:15:47 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_enemy_general_buttons(t_env *env)
{
	...
	env->editor.hud.g_enemy.pos_y = new_hud_button(ON_RELEASE,
	&change_var, &env->editor.hud.g_enemy.t_pos_y, env);
	env->editor.hud.g_enemy.pos_y.pos = new_point(170, 560);
	env->editor.hud.g_enemy.t_pos_y.pos = new_point(170, 560);
	env->editor.hud.g_enemy.pos_z = new_hud_button(ON_RELEASE,
	&change_var, &env->editor.hud.g_enemy.t_pos_z, env);
	env->editor.hud.g_enemy.pos_z.pos = new_point(170, 600);
	env->editor.hud.g_enemy.t_pos_z.pos = new_point(170, 600);
