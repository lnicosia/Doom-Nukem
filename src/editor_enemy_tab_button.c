...
/*   Updated: 2020/01/22 15:26:57 by sipatry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	env->editor.hud.s_enemy.brightness = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_enemy.color = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_enemy.intensity = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_enemy.gravity = new_hud_button(WHEN_DOWN, &change_var,
...
{
	env->editor.hud.g_enemy.pos_x = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_enemy.pos_y = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_enemy.pos_z = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_enemy.health = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_enemy.speed = new_hud_button(WHEN_DOWN, &change_var,
