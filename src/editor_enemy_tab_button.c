...
/*   Updated: 2020/03/11 11:40:14 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_enemy_sector_buttons(t_env *env)
{
	...
	env->editor.hud.s_enemy.brightness.pos = new_point(170, 520);
	env->editor.hud.s_enemy.t_brightness.pos = new_point(170, 520);
	env->editor.hud.s_enemy.color = new_hud_button(ON_RELEASE,
	&change_color, &env->editor.hud.s_enemy.t_color, env);
	env->editor.hud.s_enemy.color.pos = new_point(170, 560);
	env->editor.hud.s_enemy.t_color.pos = new_point(170, 560);
	env->editor.hud.s_enemy.intensity = new_hud_button(ON_RELEASE,
	&change_brightness_or_intensity,
	&env->editor.hud.s_enemy.t_intensity, env);
	env->editor.hud.s_enemy.intensity.pos = new_point(170, 600);
	env->editor.hud.s_enemy.t_intensity.pos = new_point(170, 600);
	env->editor.hud.s_enemy.gravity = new_hud_button(ON_RELEASE,
	&change_gravity, &env->editor.hud.s_enemy.t_gravity, env);
	env->editor.hud.s_enemy.gravity.pos = new_point(170, 640);
...
void	init_enemy_general_buttons(t_env *env)
{
	...
	env->editor.hud.g_enemy.pos_y.pos = new_point(170, 520);
	env->editor.hud.g_enemy.t_pos_y.pos = new_point(170, 520);
	...
	env->editor.hud.g_enemy.health.pos = new_point(170, 560);
	env->editor.hud.g_enemy.t_health.pos = new_point(170, 560);
	env->editor.hud.g_enemy.speed = new_hud_button(ON_RELEASE,
	&change_speed, &env->editor.hud.g_enemy.t_speed, env);
	env->editor.hud.g_enemy.speed.pos = new_point(170, 600);
	env->editor.hud.g_enemy.t_speed.pos = new_point(170, 600);
	env->editor.hud.g_enemy.scale = new_hud_button(ON_RELEASE,
	&change_enemy_scale, &env->editor.hud.g_enemy.t_scale, env);
	env->editor.hud.g_enemy.scale.pos = new_point(170, 640);
	env->editor.hud.g_enemy.t_scale.pos = new_point(170, 640);
	env->editor.hud.g_enemy.damage = new_hud_button(ON_RELEASE,
	&change_enemy_damage, &env->editor.hud.g_enemy.t_damage, env);
	env->editor.hud.g_enemy.damage.pos = new_point(170, 680);
	env->editor.hud.g_enemy.t_damage.pos = new_point(170, 680);
	env->editor.hud.g_enemy.angle = new_hud_button(ON_RELEASE,
	&change_angle, &env->editor.hud.g_enemy.t_angle, env);
	env->editor.hud.g_enemy.angle.pos = new_point(170, 720);
	env->editor.hud.g_enemy.t_angle.pos = new_point(170, 720);
}
