...
/*   Updated: 2019/09/18 11:23:17 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_rotated_object_pos(t_env *env, t_object *object)
{
	...
	object->rotated_pos.x = object->translated_pos.x
		* env->player.camera.angle_sin - object->translated_pos.z * env->player.camera.angle_cos;
	object->rotated_pos.z = object->translated_pos.x
		* env->player.camera.angle_cos + object->translated_pos.z * env->player.camera.angle_sin;
	object->rotated_pos.y = object->translated_pos.y
		+ object->rotated_pos.z * env->player.camera.angle_z;
}
