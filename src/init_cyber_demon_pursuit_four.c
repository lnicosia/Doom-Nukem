...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_cyber_demon_pursuit_four.c                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lnicosia <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/04/30 11:48:35 by lnicosia          #+#    #+#             */
/*   Updated: 2020/04/30 11:48:36 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	env->enemy_sprites[8].texture = env->enemies_start + 1;
