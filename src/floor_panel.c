...
/*   Updated: 2020/02/11 11:39:50 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (env->editor.event_panel.event.target_index == SECTOR_FLOOR_HEIGHT)
		env->editor.event_panel.target_panel.targets[0].state = DOWN;
	else if (env->editor.event_panel.event.target_index == SECTOR_FLOOR_TEXTURE)
		env->editor.event_panel.target_panel.targets[1].state = DOWN;
	else if (env->editor.event_panel.event.target_index == SECTOR_FLOOR_SLOPE)
		env->editor.event_panel.target_panel.targets[2].state = DOWN;
	else if (env->editor.event_panel.event.target_index == SECTOR_FLOOR_ALIGN_X)
		env->editor.event_panel.target_panel.targets[3].state = DOWN;
	else if (env->editor.event_panel.event.target_index == SECTOR_FLOOR_ALIGN_Y)
		env->editor.event_panel.target_panel.targets[4].state = DOWN;
	else if (env->editor.event_panel.event.target_index == SECTOR_FLOOR_SCALE_X)
		env->editor.event_panel.target_panel.targets[5].state = DOWN;
	else if (env->editor.event_panel.event.target_index == SECTOR_FLOOR_SCALE_Y)
