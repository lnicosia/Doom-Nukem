...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   draw_vline_ceiling_both.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lnicosia <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/10 16:56:56 by lnicosia          #+#    #+#             */
/*   Updated: 2020/04/29 17:33:13 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "render.h"

void	put_ceiling_pixel_both(t_drawer *drawer, t_render *render,
t_env *env)
{
...
t_render *render, t_env *env)
{
	...
	while (drawer.i <= vline.end)
	{
		...
		put_ceiling_pixel_both(&drawer, render, env);
		drawer.i++;
	}
}
