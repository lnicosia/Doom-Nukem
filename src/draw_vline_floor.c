...
/*   Updated: 2020/04/29 17:35:14 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "render.h"

void	put_floor_pixel_no_light(t_drawer *drawer, t_render *render, t_env *env)
{
		...
		t_render *render, t_env *env)
{
	...
	while (drawer.i <= drawer.vline.end)
	{
		...
		put_floor_pixel_no_light(&drawer, render, env);
		drawer.i++;
	}
}
