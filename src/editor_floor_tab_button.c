...
/*   Updated: 2020/02/03 18:06:20 by sipatry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	env->editor.hud.sp_floor_sprite.pos_x = new_hud_pos_button(ON_RELEASE, &change_var,
	...
	env->editor.hud.sp_floor_sprite.pos_y = new_hud_pos_button(ON_RELEASE, &change_var,
	...
	env->editor.hud.sp_floor_sprite.scale_x = new_hud_pos_button(ON_RELEASE, &change_var,
	...
	env->editor.hud.sp_floor_sprite.scale_y = new_hud_pos_button(ON_RELEASE, &change_var,
...
{
	env->editor.hud.s_floor.brightness = new_hud_button(ON_RELEASE, &change_var,
	...
	env->editor.hud.s_floor.intensity = new_hud_button(ON_RELEASE, &change_var,
