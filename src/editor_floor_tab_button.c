...
/*   Updated: 2020/03/11 11:39:52 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_floor_sprite_buttons(t_env *env)
{
	...
	env->editor.hud.sp_floor_sprite.scale_x.pos = new_point(170, 600);
	env->editor.hud.sp_floor_sprite.t_scale_x.pos = new_point(170, 600);
