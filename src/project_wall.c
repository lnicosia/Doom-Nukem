...
/*   Updated: 2019/09/10 19:05:56 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	sector->v[i].scale = env->camera.scale / -sector->v[i].clipped_vz;
	...
	sector->v[i].c = env->h_h + (sector->v[i].clipped_vc +
			sector->v[i].angle_z) * sector->v[i].scale;
	if (sector->v[i].c >= sector->v[i].f)
		return (1);
	sector->v[i].clipped_x = env->h_w + sector->v[i].clipped_vx
		* sector->v[i].scale;
	sector->v[i].clipped_x = ceil(sector->v[i].clipped_x);
