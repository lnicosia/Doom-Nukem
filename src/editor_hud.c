...
void	editor_options4(t_env *env)
{
...
void	editor_options3(t_env *env, t_point size)
{
...
void	editor_options2(t_env *env, t_point center, t_point size)
{
...
void	editor_options1(t_env *env, t_point center, t_point size)
{
	...
	editor_options2(env, center, size);
}
