...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   new_event_panel_value_box.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lnicosia <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/04/30 17:39:36 by lnicosia          #+#    #+#             */
/*   Updated: 2020/04/30 17:39:37 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "events.h"

int	new_event_panel_value_box4(t_input_box *box)
{
...
int	new_event_panel_value_box3(t_input_box *box, int type, void *target)
{
	char	*tmp;
	...
	return (new_event_panel_value_box4(box));
}

int	new_event_panel_value_box2(t_input_box *box, int type, void *target)
{
	size_t	len;
	size_t	dec_len;
