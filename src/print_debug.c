...
/*   Updated: 2019/05/15 15:22:33 by sipatry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		print_debug(t_env *env)
{
	...
	time = ft_itoa(SDL_GetTicks() / 1000);
	...
	print_text(new_v2(env->h - 50, env->w - 150), new_printable_text("time = ", "fonts/amazdoom/AmazDooMLeft.ttf", 0xFFFFFFFF, 30), env);
	print_text(new_v2(env->h - 50, env->w - 50), new_printable_text(time, "fonts/amazdoom/AmazDooMLeft.ttf", 0xFFFFFFFF, 30), env);
	/*ft_strdel(&near_z);
