...
void		print_debug(t_env *env)
{
	...
	print_text(new_point(h - 100, 5), new_printable_text("Near_left sector = ", env->sdl.fonts.alice30, 0xFFFFFFFF, 30), env);
	print_text(new_point(h - 50, 5), new_printable_text("Near_right sector = ", env->sdl.fonts.alice30, 0xFFFFFFFF, 30), env);
	print_text(new_point(h - 100, 255), new_printable_text(left_sector, env->sdl.fonts.alice30, 0xFFFFFFFF, 30), env);
	print_text(new_point(h - 50, 275), new_printable_text(right_sector, env->sdl.fonts.alice30, 0xFFFFFFFF, 30), env);
