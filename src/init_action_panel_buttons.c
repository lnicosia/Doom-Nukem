...
int		set_event_go_to(void *param)
{
	...
	env->editor.event_panel.action_panel.func.state = UP;
	env->editor.event_panel.action_panel.func.anim_state = REST;
...
int		set_event_func(void *param)
{
	...
	env->editor.event_panel.action_panel.add.state = UP;
	env->editor.event_panel.action_panel.add.anim_state = REST;
	env->editor.event_panel.event.mod_type = FUNC;
	return (0);
}
...
void	update_action_panel_buttons_pos(t_env *env)
{
	...
	panel->action_panel.func.pos = new_point(panel->action_panel.add.pos.x
	+ panel->action_panel.add.size_up.x + 20, panel->action_panel.add.pos.y);
...
void	init_action_panel_buttons(t_env *env)
{
	...
	env->editor.event_panel.action_panel.func = new_small_panel_button(
