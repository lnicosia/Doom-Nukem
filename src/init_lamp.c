...
{
	env->object_sprites[10].texture = env->objects_sprites_start + 1;
...
{
	env->object_sprites[9].texture = env->objects_sprites_start + 1;
...
{
	env->object_sprites[8].texture = env->objects_sprites_start + 1;
...
{
	env->object_sprites[7].texture = env->objects_sprites_start + 1;
