...
/*   Updated: 2020/01/22 14:29:41 by sipatry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	env->editor.hud.s_player.brightness = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_player.color = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_player.intensity = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.s_player.gravity = new_hud_button(WHEN_DOWN, &change_var,
...
{
	env->editor.hud.g_player.pos_x = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_player.pos_y = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_player.pos_z = new_hud_pos_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_player.health = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_player.armor = new_hud_button(WHEN_DOWN, &change_var,
	...
	env->editor.hud.g_player.speed = new_hud_button(WHEN_DOWN, &change_var,
