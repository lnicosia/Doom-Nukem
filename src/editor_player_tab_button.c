...
{
	env->editor.hud.g_player.pos_x = new_hud_pos_button(ON_RELEASE,
	...
	env->editor.hud.g_player.pos_y = new_hud_pos_button(ON_RELEASE,
	...
	env->editor.hud.g_player.pos_z = new_hud_pos_button(ON_RELEASE,
