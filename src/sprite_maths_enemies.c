...
/*   Updated: 2019/09/18 11:20:16 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_rotated_enemy_pos(t_env *env, t_enemies *enemy)
{
	...
	enemy->rotated_pos.x = enemy->translated_pos.x
		* env->player.camera.angle_sin - enemy->translated_pos.z * env->player.camera.angle_cos;
	enemy->rotated_pos.z = enemy->translated_pos.x
		* env->player.camera.angle_cos + enemy->translated_pos.z * env->player.camera.angle_sin;
	enemy->rotated_pos.y = enemy->translated_pos.y
		+ enemy->rotated_pos.z * env->player.camera.angle_z;
}
