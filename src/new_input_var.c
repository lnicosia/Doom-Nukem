...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/04/30 17:35:03 by lnicosia          #+#    #+#             */
/*   Updated: 2020/04/30 17:35:04 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		new_input_var3(t_input_box *box, int type, void *target)
{
	char	*tmp;
...
int		new_input_var2(t_input_box *box, int type, void *target)
{
	size_t	len;
	size_t	dec_len;
	...
	return (new_input_var3(box, type, target));
}
...
int		new_input_var(t_input_box *box, t_point pos, int type, void *target)
{
	...
	return (new_input_var2(box, type, target));
}
