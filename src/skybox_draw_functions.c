...
/*   Updated: 2019/09/13 09:25:20 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_skybox_wall(t_vline vline, int mode, t_render2 render, t_env *env)
{
	int			i;
	double		yalpha;
	double		y;
...
void	draw_skybox_ceiling(t_vline vline, int mode, t_render2 render, t_env *env)
{
	int		i;
	double	y;
	double	x;
...
void	draw_skybox_floor(t_vline vline, int mode, t_render2 render, t_env *env)
{
	int		i;
	double	y;
	double	x;
