...
int	new_event_panel_dialog_box2(t_input_box *box, int type, void *target)
{
	size_t	dec_len;
	size_t	len;
	...
	return (new_event_panel_dialog_box3(box, type, target));
}
...
t_env *env)
{
	...
	return (new_event_panel_dialog_box2(box, type, target));
}
