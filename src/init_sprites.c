...
/*   Updated: 2019/11/13 17:08:32 by sipatry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			init_object_sprites(t_env *env)
{
	...
	env->object_sprites[1].start[7].x = 33;
	env->object_sprites[1].start[7].y = 817;
	env->object_sprites[1].end[7].x = 58;
	env->object_sprites[1].end[7].y = 830;
	env->object_sprites[1].size[7].x = 26;
