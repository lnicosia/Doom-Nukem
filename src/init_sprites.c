...
/*   Updated: 2019/09/05 10:27:54 by gaerhard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!(env->sprites = (t_sprite*)malloc(sizeof(t_sprite) * 4)))
	...
	env->sprites[1].death_counterpart = 3;
	env->sprites[1].rest_sprite = 2;
	...
	// animation repos part 2
	env->sprites[2].texture = 34;
	env->sprites[2].death_counterpart = 3;
	env->sprites[2].rest_sprite = 1;
	...
	env->sprites[2].end[0].x = 87;
	env->sprites[2].end[0].y = 79;
	env->sprites[2].size[0].x = 44;
	env->sprites[2].size[0].y = 47;
	env->sprites[2].reversed[0] = 0;

	env->sprites[2].start[1].x = 132;
	env->sprites[2].start[1].y = 33;
	env->sprites[2].end[1].x = 163;
	env->sprites[2].end[1].y = 79;
	env->sprites[2].size[1].x = 32;
	env->sprites[2].size[1].y = 47;
	env->sprites[2].reversed[1] = 0;

	env->sprites[2].start[2].x = 208;
	env->sprites[2].start[2].y = 33;
	env->sprites[2].end[2].x = 238;
	env->sprites[2].end[2].y = 86;
	env->sprites[2].size[2].x = 31;
	env->sprites[2].size[2].y = 54;
	env->sprites[2].reversed[2] = 0;

	env->sprites[2].start[3].x = 283;
	env->sprites[2].start[3].y = 33;
	env->sprites[2].end[3].x = 317;
	env->sprites[2].end[3].y = 84;
	env->sprites[2].size[3].x = 35;
	env->sprites[2].size[3].y = 52;
	env->sprites[2].reversed[3] = 0;

	env->sprites[2].start[4].x = 362;
	env->sprites[2].start[4].y = 33;
	env->sprites[2].end[4].x = 405;
	env->sprites[2].end[4].y = 78;
	env->sprites[2].size[4].x = 44;
	env->sprites[2].size[4].y = 46;
	env->sprites[2].reversed[4] = 0;

	env->sprites[2].start[5].x = 283;
	env->sprites[2].start[5].y = 33;
	env->sprites[2].end[5].x = 317;
	env->sprites[2].end[5].y = 84;
	env->sprites[2].size[5].x = 35;
	env->sprites[2].size[5].y = 52;
	env->sprites[2].reversed[5] = 1;

	env->sprites[2].start[6].x = 208;
	env->sprites[2].start[6].y = 33;
	env->sprites[2].end[6].x = 238;
	env->sprites[2].end[6].y = 86;
	env->sprites[2].size[6].x = 31;
	env->sprites[2].size[6].y = 54;
	env->sprites[2].reversed[6] = 1;

	env->sprites[2].start[7].x = 132;
	env->sprites[2].start[7].y = 33;
	env->sprites[2].end[7].x = 163;
	env->sprites[2].end[7].y = 79;
	env->sprites[2].size[7].x = 32;
	env->sprites[2].size[7].y = 47;
	env->sprites[2].reversed[7] = 1;

	// sprites de deces du precedent
	env->sprites[3].texture = 34;
	env->sprites[3].death_counterpart = 3;
	env->sprites[3].rest_sprite = 3;
	env->sprites[3].oriented = 0;
	env->sprites[3].width = 2;
	env->sprites[3].height = 2;

	env->sprites[3].start[0].x = 44;
	env->sprites[3].start[0].y = 448;
	env->sprites[3].end[0].x = 77;
	env->sprites[3].end[0].y = 498;
	env->sprites[3].size[0].x = 34;
	env->sprites[3].size[0].y = 51;
	env->sprites[3].reversed[0] = 0;

	env->sprites[3].start[1].x = 122;
	env->sprites[3].start[1].y = 448;
	env->sprites[3].end[1].x = 157;
	env->sprites[3].end[1].y = 500;
	env->sprites[3].size[1].x = 36;
	env->sprites[3].size[1].y = 53;
	env->sprites[3].reversed[1] = 0;

	env->sprites[3].start[2].x = 202;
	env->sprites[3].start[2].y = 448;
	env->sprites[3].end[2].x = 246;
	env->sprites[3].end[2].y = 495;
	env->sprites[3].size[2].x = 45;
	env->sprites[3].size[2].y = 48;
	env->sprites[3].reversed[2] = 0;

	env->sprites[3].start[3].x = 291;
	env->sprites[3].start[3].y = 448;
	env->sprites[3].end[3].x = 358;
	env->sprites[3].end[3].y = 507;
	env->sprites[3].size[3].x = 68;
	env->sprites[3].size[3].y = 60;
	env->sprites[3].reversed[3] = 0;

	env->sprites[3].start[4].x = 403;
	env->sprites[3].start[4].y = 448;
	env->sprites[3].end[4].x = 490;
	env->sprites[3].end[4].y = 519;
	env->sprites[3].size[4].x = 88;
	env->sprites[3].size[4].y = 72;
	env->sprites[3].reversed[4] = 0;

	env->sprites[3].start[5].x = 535;
	env->sprites[3].start[5].y = 448;
	env->sprites[3].end[5].x = 637;
	env->sprites[3].end[5].y = 537;
	env->sprites[3].size[5].x = 103;
	env->sprites[3].size[5].y = 90;
	env->sprites[3].reversed[5] = 0;
	return (0);
}
