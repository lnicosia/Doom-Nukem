...
/*   Updated: 2020/01/30 12:06:02 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "env.h"

int		print_weapon_target(t_env *env, t_event *event, t_point pos)
{
...
int		print_enemy_target(t_env *env, t_event *event, t_point pos)
{
...
int		print_object_target(t_env *env, t_event *event, t_point pos)
{
...
int		print_nothing_target(t_env *env, t_event *event, t_point pos)
{
	(void)env;
	(void)event;
	(void)pos;
