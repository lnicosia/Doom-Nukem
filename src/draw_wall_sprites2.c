...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   draw_wall_sprites2.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lnicosia <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/04/29 17:43:36 by lnicosia          #+#    #+#             */
/*   Updated: 2020/04/29 17:43:37 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_env *env)
{
	...
	{
		if (env->shooting && render->z <= env->weapons[env->player.curr_weapon].
		range && start_event(&env->sectors[drawer->sector->num].
		wall_sprites[render->i].shoot_events[sprite], &env->sectors[drawer->
		sector->num].wall_sprites[render->i]. nb_shoot_events[sprite], env))
		{
			env->fatal_error = 1;
			return (1);
		}
