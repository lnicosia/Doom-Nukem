...
{
	env->object_sprites[11].texture = env->objects_sprites_start;
...
{
	env->object_sprites[12].texture = env->objects_sprites_start;
	...
	env->object_sprites[13].texture = env->objects_sprites_start;
...
{
	env->object_sprites[14].texture = env->objects_sprites_start;
	...
	env->object_sprites[15].texture = env->objects_sprites_start;
...
{
	env->object_sprites[16].texture = env->objects_sprites_start;
