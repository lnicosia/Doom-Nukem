...
int		previous_launch_condition3(int sector, t_env *env)
{
...
int		previous_launch_condition2(int sector, t_env *env)
{
	...
	return (previous_launch_condition3(sector, env));
}
...
int		previous_launch_condition(void *penv)
{
	...
	else
	{
		if (env->selected_enemy != -1)
		{
			...
			nb_launch_conditions - 1;
		return (previous_launch_condition2(sector, env));
	}
	return (0);
}
