...
/*   Updated: 2020/04/29 17:22:44 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_current_ceiling_sprite_brightness(int j, t_render *render,
...
void	draw_ceiling_sprite_brightness(int j, t_render *render,
t_drawer *drawer, t_env *env)
{
	Uint32		*sprite_pixels;
	...
	* drawer->sector->ceiling_sprites_scale[j].y + drawer->sprite->start[0].y;
	if (drawer->sprite_x >= drawer->sprite->start[0].x
		...
		* (int)drawer->sprite_y] != 0xFFC10099)
		draw_current_ceiling_sprite_brightness(j, render, drawer, env);
}
