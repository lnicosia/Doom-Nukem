...
int			precompute_floor_sprite_scales(int sector, int sprite, t_env *env)
{
	...
	object_sprites[env->sectors[sector].floor_sprites.sprite[sprite]].size[0].x
	/ env->sectors[sector].floor_sprites.scale[sprite].x;
	env->sectors[sector].floor_sprites_scale[sprite].y = env->
	object_sprites[env->sectors[sector].floor_sprites.sprite[sprite]].size[0].y
...
int			precompute_ceiling_sprite_scales(int sector, int sprite, t_env *env)
{
	...
	object_sprites[env->sectors[sector].ceiling_sprites.sprite[sprite]].size[0].x
	/ env->sectors[sector].ceiling_sprites.scale[sprite].x;
	env->sectors[sector].ceiling_sprites_scale[sprite].y = env->
	object_sprites[env->sectors[sector].ceiling_sprites.sprite[sprite]].size[0].y
