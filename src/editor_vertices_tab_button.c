...
/*   Updated: 2020/02/25 11:13:43 by sipatry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_vertices_general_buttons(t_env *env)
{
	...
	env->editor.hud.g_vertex.num.pos = new_point(250, 500);
	env->editor.hud.g_vertex.t_num.pos = new_point(250, 500);
	env->editor.hud.g_vertex.pos_x = new_hud_button(ON_RELEASE,
	NULL, &env->editor.hud.g_vertex.t_pos_x, env);
	env->editor.hud.g_vertex.pos_x.pos = new_point(250, 560);
	env->editor.hud.g_vertex.t_pos_x.pos = new_point(250, 560);
	env->editor.hud.g_vertex.pos_y = new_hud_button(ON_RELEASE,
	NULL, &env->editor.hud.g_vertex.t_pos_y, env);
	env->editor.hud.g_vertex.pos_y.pos = new_point(250, 600);
	env->editor.hud.g_vertex.t_pos_y.pos = new_point(250, 600);
}