...
/*   Updated: 2020/02/07 18:09:10 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_env *env)
{
	...
	while (i <= vline.end)
	{
		...
		{
			pixels[coord] = apply_light_color(texture_pixels[(int)x + render.texture_w * (int)y], sector.light_color, sector.intensity);
