...
void	draw_current_ceiling_bullet_hole_brightness(t_drawer *drawer,
t_env *env)
{
...
void	draw_ceiling_bullet_hole_brightness(t_bullet_hole *curr,
...
t_env *env)
{
	...
	while (bullet_holes)
	{
		...
		draw_ceiling_bullet_hole_brightness(curr, drawer, env);
