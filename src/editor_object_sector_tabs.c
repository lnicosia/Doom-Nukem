...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/05/18 14:31:07 by marvin            #+#    #+#             */
/*   Updated: 2020/05/18 15:04:26 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	print_object_sector_tab3(t_env *env)
{
...
int	print_object_sector_tab2(t_env *env)
{
	...
	if (print_text(new_point(640, 60), new_printable_text("Gravity",
		env->sdl.fonts.lato20, 0x00000000, 30), env))
		return (-1);
	return (print_object_sector_tab3(env));
}
