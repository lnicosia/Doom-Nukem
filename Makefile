...
#    Updated: 2019/07/24 11:51:49 by sipatry          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_GAME_RAW = main_game.c doom.c free_all.c map_parser.c \
		  check_parsing.c view.c init_options.c \
		  ...
		  get_screen_sectors.c map_parse_vertices.c \
		  map_parse_sectors.c map_parser_utils.c map_parse_sectors_utils.c \
		  weapons.c physics.c init_weapons.c \
		  init_program.c draw.c init_sound.c init_sprites.c \
		  init_screen_pos.c draw_sprites.c sprites_maths.c \
		  map_parse_objects.c draw_hud.c map_init_objects.c \

SRC_EDITOR_RAW = main_editor.c init_edition.c editor.c init_edit.c editor_menu.c draw_map.c
...
SRC_ALL_RAW = init_sdl.c clear_image.c init_pointers.c init_keys.c keys.c inputs.c \
		   ...
		   get_slope.c maths_utils.c movement_collision.c
