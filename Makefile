...
#    Updated: 2019/09/17 18:24:25 by gaerhard         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_ALL_RAW = init_sdl.c clear_image.c init_pointers.c init_keys.c keys.c inputs.c \
		   ...
		   map_parse_enemies.c  draw_line_free.c render2.c \
