...
int						init_wall_textures16(t_env *env);
int						init_wall_textures21(t_env *env);
int						init_wall_textures26(t_env *env);
...
int						check_player_speed_input_box(void *target);
int						check_enemy_speed_input_box(void *target);
...
int						change_player_speed(void *target);
int						change_enemy_speed(void *target);
