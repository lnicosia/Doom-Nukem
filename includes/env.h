...
/*   Updated: 2020/02/19 16:10:15 by gaerhard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int index);
int					set_sector_other_panel_buttons_state(t_target_panel *panel,
int index);
...
int index);
int					set_wall_sprite_panel_buttons_state(t_target_panel *panel,
int index);
